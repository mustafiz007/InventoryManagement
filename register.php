...
if(isset($_POST['submit'])){
    ...
    if($pass===$rPass){
     ...
     //   $pass= password_hash($pass,PASSWORD_DEFAULT);  password hashing
        ...
        <div class="container reg">
            ...
            <span>
                ...
                <div>
                    ...
                    <input type="text" id="uname"  name="uname"  onload="emptyvalue();" onchange="checkUsername(this.value); checkUser(this.value);" placeholder="enter User name" required>
                         <small id="showText" ></small>
...
<script>
  ...
  //  document.getElementsByClassName('reg').style.color='#ffce00';
